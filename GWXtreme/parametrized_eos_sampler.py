...
class mcmc_sampler():
    def __init__(self, posterior_files, prior_bounds, outfile, gridN=100, nwalkers=100,
		 Nsamples=10000, ndim=4, spectral=True, npool=1, Ns=4000, kdedim=2,logq=False):
        '''
        ...
        self.eosmodel=Stacking(posterior_files,spectral=spectral,Ns=Ns,kdedim=kdedim,logq=logq)
        self.npool=npool
        self.gridN=gridN
